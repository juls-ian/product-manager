<script setup>
   ...
   // same event emitted in the Modal component
...
<template>
   <Modal :show="show" max-width="xl" @close="emit('close')">
      <form class="relative bg-white rounded-lg shadow" @submit.prevent="bulkUpdate">
         <!-- Modal header -->
            ...
            <div class="grid grid-cols-6 gap-6">
               <div class="col-span-6 sm:col-span-6">
                  ...
                  <div class="font-sm text-red-500 mt-2" v-if="form.errors.product_ids">
                     You need to choose one product or more
                  </div>
               </div>
               <div class="col-span-6 sm:col-span-6">
                  ...
                  >
                     ...
                     <option
                        ...
                        :value="category.id"
                        :class="{
                           'bg-red-50 border border-red-500 text-red-900': form.errors.category_id,
